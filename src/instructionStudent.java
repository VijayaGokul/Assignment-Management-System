...
public String rollNo;
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("1. Read the instructions carefully: Make sure to read the instructions for the assignment thoroughly, \n   including any guidelines or requirements. \n   This will help you to understand what is expected of you and how to approach the assignment.\n\n2. The Students may not use his or her textbook,course notes or any other outside source.\n\n3. Submit on time: Be mindful of the submission deadline and ensure that you submit the assignment on time.\n\n\n\n");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 108, 1342, 480));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(675, 643, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        new assignmentStudent(rollNo).setVisible(true);
